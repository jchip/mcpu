...
2. Migrate your existing MCP servers from Claude Desktop, Claude CLI, and/or Gemini CLI:
...
Migrate MCP servers from Claude Desktop, Claude CLI, and/or Gemini CLI to MCPU. This automates the initial setup:
